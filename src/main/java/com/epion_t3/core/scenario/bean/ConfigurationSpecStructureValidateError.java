...
public class ConfigurationSpecStructureValidateError extends ConfigurationSpecValidateError {
    ...
    public ConfigurationSpecStructureValidateError(StageType stage, NotificationType level, String message, Throwable error, String customName, String structureName) {
