 ...
 */
@Slf4j
public abstract class AbstractFlowRunner<EXECUTE_CONTEXT extends ExecuteContext, EXECUTE_SCENARIO extends ExecuteScenario, EXECUTE_FLOW extends ExecuteFlow, FLOW extends Flow>
     ...
     * @param flow Flow
     */
    protected abstract FlowResult execute(Context context, EXECUTE_CONTEXT execute_context,
     ...
     * @param flow Flow
     */
    protected void onFinally(final Context context, final EXECUTE_CONTEXT execute_context,
            final EXECUTE_SCENARIO executeScenario, final EXECUTE_FLOW executeFlow, final FLOW flow,
            final Logger logger) {
        // 必要に応じてオーバーライド実装すること.
    }
